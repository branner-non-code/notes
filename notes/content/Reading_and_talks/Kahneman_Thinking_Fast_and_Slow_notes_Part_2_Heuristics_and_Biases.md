 ...
 * p. 129-130: **availability heuristic**: ease with which instances of a class seem to come to mind. Both systems are involved.

 * When estimating the size of a category, System 1 substitutes "an impression of the ease with which instances come to mind."
 * p. 131: "Resisting this large collection of potential availability biases is possible, but tiresome."
 * **availability bias**: people remember their own or proximate instances more clearly than others, and "the difference in avilability leads to a difference in judged frequency. The bias is not necessarily self-serving."
 ...
 * pp. 131-32: Norbert Schwarz: "The task of listing instances may enhance the judgments of the trait by two different routes: the number of instances retrieved" and "the ease with which they come to mind."
 ...
 * pp. 132-33. Paradoxical: "Frowning normally accompanies cognitive strain and the effect is symmetric; when people are instructed to frown while doing a task, they actually try harder and experience greater cognitive strain." This leads to an impression of lower fluency and with it an estimate of lower frequency. Smiling leads to the opposite.

 * "The paradox is not always found: people sometimes go by content rather than by ease of retrieval." "The participants make an inference: if I am having so much more trouble than expected coming up with instances of my assertiveness, then I can't be very assertive. Note that this inference rests on a surprise — fluency being worse than expected. The availability heuristic that the sujects apply is better described as an 'unexplained unavailability' heuristic."
