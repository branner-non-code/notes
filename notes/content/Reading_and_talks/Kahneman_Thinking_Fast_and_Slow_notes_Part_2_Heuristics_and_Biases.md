 ...
 * p. 110-11: Wainer and Zwerling, cancer rates. "System 1 is inept when faced with 'merely statisical' facts, which change the probability of outcomes but do not cause them to happen."
 ...
 * pp. 115-16: William Feller: WWII bombing of London "revealed conspicuous gaps", assumed to be where German spies were living. Feller: "To the untrained eye randomness appears as regularity or tendency to cluster"
 
 * p. 116: Kahneman advised Israeli Air Force officers that different bombing damage to different bases was "due to blind luck and that the interviewing of the pilotes should stop."
 ...
 * pp. 123-24. **Anchoring index**: "the ratio of the two differences expressed aas a percentage." Assuming two anchors, the difference between two corresponding estimates and the difference between the two anchors. 
