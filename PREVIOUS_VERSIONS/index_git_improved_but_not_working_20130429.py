...
def list_all_words(string_and_path_lookup, wnl_obj):
    ...
    # dictionary
    words_to_report = []
    for the_string in string_and_path_lookup:
        words_to_divide = []
        words_not_to_divide = []
        the_string = the_string.lower()
        # ggg later, use regex here
...
def main():
    ...
    for the_dir in list_of_dirs:
        ...
        string_and_path_lookup = add_string_and_path_to_dict(
    ...
    words = list_all_words(string_and_path_lookup, wnl_obj)
    print len(words)
...
#        print '\n', word, string_and_path_lookup[the_hash]
